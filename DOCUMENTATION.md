...
- **Last updated:** 2026-05-11 (added `cc-gads-ensure-adc` preflight auto-healer + mandatory Preflight section in SKILL.md; ADC manual setup deprecated). Prior: 2026-05-08 (added — first skill to introduce the "Skill-bundled tools" powerup category; see Powerup taxonomy below).
