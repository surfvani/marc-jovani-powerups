...
BOOT SEQUENCE — before saying anything:
    ...
    3b. RE-ARM MARC'S DIRECT LINE (it dies with the session — see Hard-Won, `mgr`):
         ...
         Then read that file's tail for anything that arrived while you were down,
         and answer it in ~/.claudemanager.replies.
