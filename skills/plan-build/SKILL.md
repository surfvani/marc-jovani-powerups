...
STEP 1: User describes the project. Start by investigating, reading any documents they gave you. Gather all information needed. If working with Marc: if the /how-marc-works skill is available, load it now — it contains Marc's builder profile (workflow, pain points, architectural principles, technical context) and must inform every architecture and infrastructure decision from this point forward.
